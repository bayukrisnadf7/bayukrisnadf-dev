...
const Section3 = () => {
  return (
    <div id="section3" className="w-full min-h-screen bg-black text-white">
      <p className="text-[#FFA28B] md:text-3xl md:py-0 py-10 text-2xl text-center font-bold relative">
        Project
      </p>

      <div className="grid md:grid-cols-3 grid-cols-1 gap-8 place-items-center md:mt-[50px] md:mx-20 mx-5">
        <FadeContent
          blur={true}
          duration={1000}
          easing="ease-out"
        ...
        >
          <div className="flex flex-col gap-5 max-w-[500px] p-5 rounded-xl bg-slate-900">
            <img
              ...
              alt=""
              // width={500}
              className="rounded-xl w-[500px] md:h-[250px] h-[200px]"
            />
          ...
          <div className="flex flex-col gap-5 max-w-[500px] p-5 rounded-xl bg-slate-900 ">
            ...
            <div className="flex flex-col gap-4 mx-2">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[#8B949E] md:text-base text-sm md:max-w-xl max-w-[300px]">
                  Mengembangkan aplikasi untuk pasien melakukan konsultasi
                  kepada dokter
                </p>
              </div>
              <div className="flex gap-3">
          ...
          <div className="flex flex-col gap-5 max-w-[500px] p-5 rounded-xl bg-slate-900">
            ...
            <div className="flex flex-col gap-4 mx-2">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[#8B949E] md:text-base text-sm md:max-w-xl max-w-[300px]">
                  Mengembangkan aplikasi untuk rapot penilaian siswa sekolah
                  dasar
                </p>
              </div>
              <div className="flex gap-3">
          ...
          <div className="flex flex-col gap-5 max-w-[500px] p-5 rounded-xl bg-slate-900 ">
            ...
            <div className="flex flex-col gap-4 mx-2">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[#8B949E] md:text-base text-sm md:max-w-xl max-w-[300px]">
                  Mengembangkan aplikasi untuk memperluas edukasi mengenai
                  Energi Terbarukan
                </p>
              </div>
              <div className="flex gap-3">
          ...
          <div className="flex flex-col gap-5 max-w-[500px] p-5 rounded-xl bg-slate-900">
            ...
            <div className="flex flex-col gap-4 mx-2">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[#8B949E] md:text-base text-sm md:max-w-xl max-w-[300px]">
                  Mengembangkan aplikasi untuk klasifikasi kualitas jenis biji
                  kopi
                </p>
              </div>
              <div className="flex gap-3">
